...
namespace FastPlatformer.Scripts.UI
{
    public class AvatarControllerVisualDebug : MonoBehaviour
    {
        ...
        void OnGUI()
        {
            GUI.Box(new Rect(10, 10, 240, 160), "<b>Character Debug</b>");
            ...
            GUI.Label(new Rect(20, 120, 200, 20), $"<b>Move Status:</b> {ExampleCharacterController.CurrentMoveState.ToString()}");
            GUI.Label(new Rect(20, 140, 200, 20), $"<b>Velocity:</b> {CharacterMotor.Velocity}");
        }
    }
}
