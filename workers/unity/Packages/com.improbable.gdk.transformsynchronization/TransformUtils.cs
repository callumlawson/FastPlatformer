...
namespace Improbable.Gdk.TransformSynchronization
{
    public static class TransformUtils
    {
        ...
        public static float SquareDisatnce(Coordinates a, Coordinates b)
        {
            return (float) ((a.X - b.X) * (a.X - b.X) + (a.Y - b.Y) * (a.Y - b.Y) + (a.Z - b.Z) * (a.Z - b.Z));
        }

        public static float SquareDisatnce(Location a, Location b)
        {
            return (a.X - b.X) * (a.X - b.X) + (a.Y - b.Y) * (a.Y - b.Y) + (a.Z - b.Z) * (a.Z - b.Z);
        }

        public static float SquareDisatnce(Velocity a, Velocity b)
        {
            return (a.X - b.X) * (a.X - b.X) + (a.Y - b.Y) * (a.Y - b.Y) + (a.Z - b.Z) * (a.Z - b.Z);
        }
